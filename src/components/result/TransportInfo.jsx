...
export default function TransportInfo({ transportInfo, travelMode, isDark }) {
  return (
    <div className="mt-8">
            ...
            {ti.info.type === "car" ? (
              ...
              <div className="space-y-2">
                <div className="flex items-start gap-2 text-sm" style={{ color: "var(--text-secondary)" }}>
                  ...
                  <div><span className="font-medium" style={{ color: "var(--text-primary)" }}>시외버스:</span> {ti.info.intercity}</div>
                </div>
                <div className="flex items-start gap-2 text-sm" style={{ color: "var(--text-secondary)" }}>
                  <Footprints className="w-4 h-4 text-[#00A86B] mt-0.5 shrink-0" />
                  <div><span className="font-medium" style={{ color: "var(--text-primary)" }}>시내버스:</span> {ti.info.local}</div>
                </div>
              </div>
            )}
          </div>
